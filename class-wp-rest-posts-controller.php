<?php
/**
 * WP REST API Lab Simulation – Content Injection by VeryLazyTech
 *
 * Description:
 * This custom lab script simulates the WordPress 4.7.0 / 4.7.1
 * Content Injection vulnerability in a controlled environment.
 *
 * Key Features:
 * - Safe for lab testing: Only modifies an internal simulated post array.
 * - Simulates the REST API endpoint for post updates.
 * - Demonstrates how an attacker could update post content without proper auth.
 * - Educational use only: For penetration testing practice in isolated labs.
 *
 * Example Usage:
 * POST to http://localhost/wp-lab-rest/posts/1
 * with JSON body: {"title": "Injected Title", "content": "Injected Content"}
 *
 * Purpose:
 * - Practice Content Injection techniques.
 * - Test exploit scripts safely.
 * - Understand how WordPress REST API parameters can be abused.
 *
 * Author: VeryLazyTech
 * Author URI: https://www.verylazytech.com
 */
